                        ...
                        <div className="flex flex-col items-start lg:justify-self-end gap-5">
                            ...
                            <ul className="flex flex-col gap-4 text-[15px] font-normal text-white w-full">
                                ...
                                <li className="flex items-center gap-3">
                                    ...
                                    <a href="tel:+34950123456" className="hover:text-white transition-colors block">+34 950 123 456</a>
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="text-white">
                                    ...
                                    <a href="mailto:info@organic-bio.es" className="hover:text-white transition-colors block">info@organic-bio.es</a>
                                </li>
                            </ul>
                        </div>
                    </div>
