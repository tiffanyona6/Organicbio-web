            ...
            <div className="container-global">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-20">
                    ...
                    <div className="bg-gray-50/50 rounded-[32px] p-8 lg:p-10 border border-gray-100 flex flex-col items-start shadow-sm hover:shadow-md transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-org-dark mb-4">Sede Central</h3>
                        <p className="text-[14px] text-gray-500 leading-relaxed font-normal">
                            Calle Alcudia de Monteagud,<br />
                    ...
                    <div className="bg-gray-50/50 rounded-[32px] p-8 lg:p-10 border border-gray-100 flex flex-col items-start shadow-sm hover:shadow-md transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-org-dark mb-2">Email Directo</h3>
                        <a href="mailto:info@organic-bio.es" className="text-green-org font-bold hover:underline mb-2 block">info@organic-bio.es</a>
                        <p className="text-[13px] text-gray-400 font-normal">Atención comercial B2B</p>
                    </div>
                    ...
                    <div className="bg-gray-50/50 rounded-[32px] p-8 lg:p-10 border border-gray-100 flex flex-col items-start shadow-sm hover:shadow-md transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-org-dark mb-2">Teléfono</h3>
                        <a href="tel:+34950123456" className="text-green-org font-bold hover:underline mb-2 block">+34 950 123 456</a>
                        <p className="text-[13px] text-gray-400 font-normal text-start">Lun - Vie: 08:00 - 18:00</p>
                    </div>
                    ...
                    <div className="bg-gray-50/50 rounded-[32px] p-8 lg:p-10 border border-gray-100 flex flex-col items-start shadow-sm hover:shadow-md transition-all">
                        ...
                        <h3 className="text-xl font-bold text-gray-org-dark mb-2">WhatsApp</h3>
                        ...
                        <p className="text-[13px] text-gray-400 font-normal">Soporte rápido exportación</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-org-dark text-lg mb-2">Soporte 24/7</h4>
                            <p className="text-gray-500 text-[15px] leading-relaxed font-normal">
                                Atención continua para incidencias logísticas internacionales y seguimiento de pedidos.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-org-dark text-lg mb-2">Asesoría Técnica</h4>
                            <p className="text-gray-500 text-[15px] leading-relaxed font-normal">
                                Expertos en calidad agrícola para asegurar que el producto cumple sus estándares exactos.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-gray-org-dark text-lg mb-2">Gestión Logística</h4>
                            <p className="text-gray-500 text-[15px] leading-relaxed font-normal">
                                Optimización de rutas y cadena de frío para exportaciones a toda Europa y Reino Unido.
                            </p>
                        </div>
                    </div>
